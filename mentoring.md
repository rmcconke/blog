...
# Mentees
I've had the privilege of working with several highly talented students on some really fun research projects! Here's a list of some of my mentees and the projects we worked on together.

- [**Julian Schmid**](https://www.linkedin.com/in/julian-schmid03/) (2026, MIT). Julian was a visiting Masters student from Imperial. We worked on constitutive modelling for solid mechanics using equivariant graph neural networks in [CHEFSI](https://chefsi.mit.edu/). We also worked on trying to get big in the gym. Check out Julian's [Chipotle order optimizer](https://nailujj.github.io/ChipotleMaxxing/) that he developed while at MIT. Preprint coming soon :)
- [**Landon Hering**](https://landododo.github.io) (2026, MIT). We worked on inpainting submesoscale ocean dynamics onto Surface Water and Ocean Topography (SWOT) measurements, using a model trained on the LLC4320 dataset. Check out Landon's [blog post](https://landododo.github.io/swot-research/) about the project.
- [**Siiri Roschier**](https://fi.linkedin.com/in/siiri-roschier) (2025-2026, MIT). We worked on optimizing hyperparameters of various equivariant models for generative stochastic subgrid scale modelling in ocean turbulence.
- [**David De La Torre**](https://www.linkedin.com/in/david-delatorre/) (2025, MIT). We explored using [stochastic rounding](https://nhigham.com/2020/07/07/what-is-stochastic-rounding/) for lattice Boltzmann method fluid dynamics simulations using single precision floating point representations. You can read more about our project and results in [this blog post](https://ryleymcconkey.com/2025/07/stochastic_rounding_lbm/)
- [**Ali Backour**](https://www.linkedin.com/in/ali-backour-89aa6b237/) (2025, MIT). I co-supervised Ali with [Julia Balla](https://julballa.github.io/). We explored using [equivariance](https://en.wikipedia.org/wiki/Equivariant_map#:~:text=In%20mathematics%2C%20equivariance%20is%20a,the%20action%20of%20the%20group.) as an inductive bias in neural networks for superresolution of Kolmogorov forced turbulence. I presented our results in April at the ERCOFTAC Data-driven Fluid Mechanics Workshop ([slides](/docs/2025.04.02 ERCOFTAC Workshop Presentation.pdf)) and at Chalmers University of Technology [slides](/docs/2025.04.14 Talk at Chalmers University of Technology.pdf).  
- [**Jeremiah Bailey**](https://www.linkedin.com/in/jeremiah-bailey-2650jb510/) (2025, MIT). I co-supervised Jeremiah's summer internship with [Julia Balla](https://julballa.github.io/). We continued Ali's work, but expanded our investigation to include 3D homogeneous isotropic turbulence, and 3D turbulent channel flow. We presented a [NeurIPS Workshop Paper](https://ml4physicalsciences.github.io/2025/files/NeurIPS_ML4PS_2025_226.pdf) at the Machine Learning for Physical Sciences workshop in San Diego. 
