...
- [**Siiri Roschier**](https://fi.linkedin.com/in/siiri-roschier) (2025-2026, MIT). We are currently working on optimizing hyperparameters of various equivariant models for generative stochastic subgrid scale modelling in ocean turbulence. The end goal of our project is to answer the question: is equivariance a useful inductive bias for quasi-geostrophic ocean models? More to come :)
