...
- [**Landon Hering**](https://www.linkedin.com/in/landon-hering-b69a57325) (2026-present, MIT). We're working on inpainting submesoscale ocean dynamics onto Surface Water and Ocean Topography (SWOT) measurements, using a model trained on the LLCC4320 dataset. This model will allow us to super-resolve submesoscale dynamics from satellite measurements. 
- [**Siiri Roschier**](https://fi.linkedin.com/in/siiri-roschier) (2025-present, MIT). We are currently working on optimizing hyperparameters of various equivariant models for generative stochastic subgrid scale modelling in ocean turbulence. The end goal of our project is to answer the question: is equivariance a useful inductive bias for quasi-geostrophic ocean models?
