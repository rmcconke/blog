...
- [**Landon Hering**](https://landododo.github.io) (2026, MIT). We're working on inpainting submesoscale ocean dynamics onto Surface Water and Ocean Topography (SWOT) measurements, using a model trained on the LLCC4320 dataset. Check out Landon's [blog post](https://landododo.github.io/swot-research/) about the project.
