...
- [**Siiri Roschier**](https://fi.linkedin.com/in/siiri-roschier) (2025-2026, MIT). We are currently working on optimizing hyperparameters of various equivariant models for stochastic subgrid scale modelling in ocean modelling. The end goal of our project is to answer the question: is equivariance a useful inductive bias in subgrid scale modelling for quasi-geostrophic ocean models? More to come :)
